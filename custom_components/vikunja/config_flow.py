...
class VikunjaConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None) -> FlowResult:
        ...
        if user_input is not None:
            ...
            device_mode = user_input.get(CONF_DEVICES_MODE)
            enable_todo = user_input.get(CONF_ENABLE_TODO, True)

            logging.info(f"mode came through as {device_mode}")
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Optional(CONF_DEVICE_MODE, default=list(CONF_DEVICE_MODES.values())[0]): vol.In(
                    list(CONF_DEVICE_MODES.values())),
                vol.Optional(CONF_ENABLE_TODO, default=True): bool,
    ...
    async def async_step_init(self, user_input=None):
        ...
        if user_input is not None:
            ...
            data = {
                ...
                CONF_ENABLE_TODO: user_input[CONF_ENABLE_TODO]
            }
        ...
        return self.async_show_form(
            ...
            data_schema=vol.Schema({
                ...
                vol.Optional(CONF_DEVICE_MODE, default=self.config_entry.data.get(CONF_DEVICE_MODE,
                                                                                  CONF_DEVICE_MODES.values()[
                                                                                      0])): vol.In(
                    CONF_DEVICE_MODES.values()),
                vol.Optional(CONF_ENABLE_TODO, default=self.config_entry.data.get(CONF_ENABLE_TODO, True)): bool,
